# teshub masternode install script
# Edited by Robbowz
VERSION="0.2"
NODEPORT='23500'
RPCPORT='23502'
...
#Setting auto start cron job for teshubd
cronjob="@reboot sleep 30 && /root/teshub/teshubd"
crontab -l > tempcron
...
echo "All done!"
cd ~/
sudo rm /root/teshub_ubuntu_install.sh
